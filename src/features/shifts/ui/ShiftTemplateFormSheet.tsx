...
export function ShiftTemplateFormSheet({
  ...
  return (
    <BottomSheet
      open={open}
      title={editing ? 'お気に入りシフトを編集' : 'お気に入りシフトを作成'}
      onClose={onClose}
    >
      <form
        noValidate
      ...
      >
        ...
        <label className="flex flex-col gap-1">
          <span className="text-meta text-ink-secondary">シフト名</span>
        ...
        <div className="flex gap-3">
          <label className="flex flex-1 flex-col gap-1">
            <span className="text-meta text-ink-secondary">休憩(分)</span>
            <input
              type="number"
              inputMode="numeric"
              min={0}
          ...
          <label className="flex flex-1 flex-col gap-1">
            <span className="text-meta text-ink-secondary">時給(円)</span>
            <input
              type="number"
              inputMode="numeric"
              min={0}
        ...
        <label className="flex flex-col gap-1">
          <span className="text-meta text-ink-secondary">勤務先ラベル(任意)</span>
          <input
            value={workplace}
